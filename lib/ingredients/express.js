...
module.exports = {
  ...
  run : function(program,pkg,destination_path,app_name,done){
    emptyDirectory(destination_path, function(empty){
      if (empty || program.force) {
        createApplicationAt(destination_path,program,app_name,done);
      } else {
...
function createApplicationAt(path,program,app_name,callback) {
  // Template engine

  program.template = 'ejs-html';
  ...
  mkdir(path, function(){
    ...
    mkdir(path + '/views', function(){
      switch (program.template) {
        case 'ejs-html':
          copy_template('express/ejs-html/index.html', path + '/views/index.html');
          copy_template('express/ejs-html/layout.html', path + '/views/layout.html');
          copy_template('express/ejs-html/error.html', path + '/views/error.html');
          break;
        case 'ejs':
